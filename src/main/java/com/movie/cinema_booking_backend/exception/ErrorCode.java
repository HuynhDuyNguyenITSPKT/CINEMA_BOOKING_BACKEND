...
public enum ErrorCode {
    ...
    PAYMENT_INVALID_REQUEST(2004, "Yêu cầu thanh toán không hợp lệ", HttpStatus.BAD_REQUEST),
    PAYMENT_METHOD_NOT_SUPPORTED(2005, "Phương thức thanh toán không được hỗ trợ", HttpStatus.BAD_REQUEST),
    PAYMENT_SIGNATURE_INVALID(2006, "Chữ ký thanh toán không hợp lệ", HttpStatus.BAD_REQUEST),
    PAYMENT_GATEWAY_ERROR(2007, "Có lỗi từ cổng thanh toán", HttpStatus.BAD_GATEWAY);
